        ...
        <div className="mb-6">
          ...
          <div className="mb-6">
            <Input
              ...
              min={MIN_DEPOSIT}
              max={MAX_DEPOSIT}
              className="w-full font-medium py-3 px-4 rounded-3xl text-xs transition-all duration-300 text-center py-4 h-auto bg-black/60 border-yellow-500/30 focus:border-yellow-400 backdrop-blur-sm focus:outline-none focus:ring-2 focus:ring-yellow-500"
